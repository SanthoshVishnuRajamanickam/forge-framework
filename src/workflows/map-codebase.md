<purpose>
Orchestrate parallel Explore agents to analyze codebase and produce structured documents in .forge/codebase/
...
4. **Write to .forge/codebase/{NAME}.md** (uppercase filename)
...
If .forge/STATE.md exists, note that codebase has been mapped.

Add to Accumulated Context section:
```
### Codebase Mapped
Date: [current date]
Documents: .forge/codebase/ (7 files)
```
...
**Initialize FORGE project** — use codebase context for planning
...
<success_criteria>
- .forge/codebase/ directory created

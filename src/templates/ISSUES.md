...
Template for `.forge/ISSUES.md` — deferred enhancements discovered during execution.
...
**Location:** `.forge/ISSUES.md` (project-level, not phase-level)
...
2. Log to `.forge/ISSUES.md` with ISS-NNN format

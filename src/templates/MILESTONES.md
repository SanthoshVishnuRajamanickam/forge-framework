...
Template for `.forge/MILESTONES.md` — the project's milestone log.
...
```markdown
# Project Milestones: FORGE Framework
...
**Delivered:** FORGE framework foundation with Plan-Apply-Unify loop
...
- CARL FORGE domain with 11 rules

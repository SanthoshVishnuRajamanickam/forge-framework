...
Template for milestone archives at `.forge/milestones/v{VERSION}-{NAME}.md`.
...
**Pattern:** `.forge/milestones/v{VERSION}-{NAME}.md`
...
**Reason:** Improve agent context for FORGE projects

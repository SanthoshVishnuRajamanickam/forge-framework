...
Template for `.forge/codebase/STRUCTURE.md` - captures physical file organization.
...
**src/templates/**
- Purpose: Document templates for .forge/ files
...
**src/**
- Purpose: Resources installed to ~/.claude/forge-framework/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**.forge/**
- Purpose: Project state (created in target projects)
- Source: Generated by /forge:init

...
Template for `.forge/MILESTONE-CONTEXT.md` — temporary handoff from discuss-milestone to create-milestone.
...
**Generated:** {{DATE}}
**Status:** Ready for /forge:create-milestone
...
*This file is temporary. It will be deleted after /forge:create-milestone creates the milestone.*
...
**Estimated phases:** 3
**Focus:** Complete milestone management tooling for FORGE framework

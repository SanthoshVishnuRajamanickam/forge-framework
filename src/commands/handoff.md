...
Create `.forge/HANDOFF-{date}-{context}.md`:
...
**Resume:** `/forge:resume` then read this handoff
...
Saved: .forge/HANDOFF-{date}-{context}.md
...
Next session: /forge:resume → read handoff
════════════════════════════════════════
```
</step>

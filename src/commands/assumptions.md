...
**Distinction from /forge:discuss:** This command shows what CLAUDE thinks. The discuss command gathers what USER wants.
</objective>

<execution_context>
@~/.claude/forge-framework/workflows/phase-assumptions.md
</execution_context>
...
<process>
Follow workflow: @~/.claude/forge-framework/workflows/phase-assumptions.md
</process>

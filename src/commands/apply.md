...
<execution_context>
@~/.claude/forge-framework/workflows/apply-phase.md
...
<step name="execute">
Follow workflow: @~/.claude/forge-framework/workflows/apply-phase.md
...
- Report: "APPLY complete. Run /forge:unify to close loop."
- Show files modified
...
- [ ] Next action clear (run /forge:unify)
</success_criteria>
